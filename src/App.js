...
// Címek (állítsd be a saját kontraktod címét!)
...
export default function App() {
  ...
  // --- Role fetch + connect csak jogosultaknak ---
  ...
  // --- CONNECT WALLET (csak jogosultak!) ---
  ...
  async function handlePause() {
    ...
    try {
      ...
      toastId = toast.loading(
        <div>
          {actionText} transaction submitted...<br />
          <a href={etherscanLink} target="_blank" rel="noopener noreferrer" className="text-white font-bold underline">View on Etherscan</a>
        </div>
      );
